 ...
 */
function processEntitiesByType(data, entityType) {
    switch (entityType) {
        case "Facility":
 ...
 */
function generateOpsList(facilities, selectedTypes) {
    const allOps = facilities.flatMap(data => selectedTypes.flatMap(entityType => processEntitiesByType(data, entityType)));
 ...
 */
async function publishOpsInBatches(spaceId, allOps, batchSize = 10) {
...
//# sourceMappingURL=publish-entities.js.map