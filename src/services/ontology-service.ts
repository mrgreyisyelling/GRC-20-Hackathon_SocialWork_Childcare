...
static generateLocationOntologyOps(): EntityOp[] {
   ...
   */
  static async setupOntology(spaceId: string, generateOpsFn: () => EntityOp[], spaceName: string): Promise<void> {
    if (!spaceId) {
   ...
   */
  static async setupFacilityOntology(spaceId: string = SpaceIds.FACILITY): Promise<void> {
   ...
   */
  static async setupLicenseOntology(spaceId: string = SpaceIds.LICENSE): Promise<void> {
   ...
   */
  static async setupDateOntology(spaceId: string = SpaceIds.DATE): Promise<void> {
   ...
   */
   static async setupLocationOntology(spaceId: string = SpaceIds.LOCATION): Promise<void> {
  ...
  static async setupOntologies(
    facilitySpaceId: string = SpaceIds.FACILITY,
    licenseSpaceId: string = SpaceIds.LICENSE,
    dateSpaceId: string = SpaceIds.DATE,
    locationSpaceId: string = SpaceIds.LOCATION
  ): Promise<void> {
